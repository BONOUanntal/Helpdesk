...
var TicketsController = function () {
    var _classDecorators = [(0, common_1.Controller)('tickets')];
    ...
    var TicketsController = _classThis = /** @class */ (function () {
        ...
        TicketsController_1.prototype.create = function (body, req) {
        ...
        TicketsController_1.prototype.update = function (id, body, req) {
            return this.ticketsService.update(Number(id), body, req.user.userId);
        };
        TicketsController_1.prototype.findAll = function (req) {
            var user = req.user;
            console.log("USER:", req.user);
            return this.ticketsService.findAll(user.userId, user.role, user.clientId);
        };
        TicketsController_1.prototype.remove = function (id, req) {
            return this.ticketsService.remove(Number(id), req.user.userId);
        };
